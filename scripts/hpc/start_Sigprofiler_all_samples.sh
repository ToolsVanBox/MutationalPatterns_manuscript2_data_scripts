...
for DIR in experiments/*; do
    ...
    output_dir=${PWD}/${DIR}/"sigprofiler_output/"
    ...
    for mut_mat in ${DIR}/simulated_data/*.txt; do
        ...
        for penalty in 0.1 0.05 0.01 0.005 0.001 0.0005; do
            ...
            if [[ ! -f "${output_file}" ]]; then
                sbatch -e "${output_dir_final}/run_Sigprofiler_error.txt" -o "${output_dir_final}/run_Sigprofiler_output.txt" run_Sigprofiler.sh ${full_name_mut_mat} ${output_dir_final} ${context_type} ${penalty}
